...
const Footer = () => {
  return (
    <footer className="bg-primary fixed bottom-0 w-full text-accent border-t-[3px] border-[tomato] py-5 flex items-center uppercase font-[droid_serifbold]">
      <div className="ml-20 flex items-center gap-12">
