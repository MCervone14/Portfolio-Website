...
const AboutSection = () => {
  return (
    <section id="about" className="h-full py-20">
      <div
        className="max-screen-2xl flex flex-col xl:flex-row justify-center mx-auto w-full h-full"
        initial="initial"
        whileInView="animate"
      >
        <div className="flex flex-col px-5 w-full lg:w-1/2 mx-auto mb-10">
          <h2 className="text-3xl mb-5 text-title">About Me</h2>
          ...
          <h2 className="text-3xl mb-5 text-title">Hobbies</h2>
          <p className="text-2xl mb-4 leading-relaxed">
